...
public record IntegerGroupData(int val1, int val2, int val3, int val4, int val5) {
    public static final Codec<IntegerGroupData> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.INT.fieldOf("val5").forGetter(IntegerGroupData::val5)
    ...
    public static final StreamCodec<ByteBuf, IntegerGroupData> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.INT, IntegerGroupData::val5,
            IntegerGroupData::new
    );
    public static final IntegerGroupData EMPTY = new IntegerGroupData(0, 0, 0, 0, 0);
}
