...
public class SuspiciousUSBFlashDriveItem extends Item {
    public SuspiciousUSBFlashDriveItem() {
        super(com.linngdu664.bsf.Main.itemProperties().rarity(Rarity.EPIC));
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display, Consumer<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        tooltipComponents.accept(Component.translatable("suspicious_usb_flash_drive.tooltip").withStyle(ChatFormatting.GRAY));
        tooltipComponents.accept(Component.translatable("suspicious_usb_flash_drive1.tooltip").withStyle(ChatFormatting.GRAY));
        tooltipComponents.accept(Component.translatable("suspicious_usb_flash_drive2.tooltip", Minecraft.getInstance().options.keyUse.getTranslatedKeyMessage()).withStyle(ChatFormatting.DARK_GRAY));
    }
}
