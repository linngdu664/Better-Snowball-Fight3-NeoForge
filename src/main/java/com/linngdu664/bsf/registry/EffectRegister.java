...
import com.linngdu664.bsf.effect.WallhackEffect;
...
public class EffectRegister {
    ...
    public static final DeferredHolder<MobEffect, MobEffect> WALLHACK = EFFECTS.register("wallhack", () -> new WallhackEffect(MobEffectCategory.BENEFICIAL, 0x5662f6));
}
