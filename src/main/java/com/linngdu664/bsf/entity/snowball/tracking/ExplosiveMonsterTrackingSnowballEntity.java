...
public class ExplosiveMonsterTrackingSnowballEntity extends AbstractMonsterTrackingSnowballEntity {
    ...
    public ExplosiveMonsterTrackingSnowballEntity(LivingEntity pShooter, Level pLevel, ILaunchAdjustment launchAdjustment, RegionData region) {
        super(EntityRegister.EXPLOSIVE_MONSTER_TRACKING_SNOWBALL.get(), pShooter, pLevel, new BSFSnowballEntityProperties().basicDamage(3).basicBlazeDamage(5).applyAdjustment(launchAdjustment), false, region);
    }
